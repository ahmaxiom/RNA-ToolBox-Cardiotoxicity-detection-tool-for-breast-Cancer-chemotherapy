function [P, J, smoothedPoly,seedPointx,ext_energy] = regionGrowing2(ImgO,n,seedPoint,numofIter,numofIterRG)
...
J=imdilate(J,strel('rectangle',[8 2]));
%seg=imfilter(seg,ones(11)/121);
%seg=imdilate(seg,strel('rectangle',[8 2]));
%figure,imshow(J)
